...
const Feedback = () => {
    ...
    return (
        <DefaultTemplate>
            <div className="bc_article d-flex flex-column overflow-hidden border border-top-0" style={{ height: 'calc(100vh - 112px)' }}>
                <HeaderChat />
                <div className="bc_article-chat_view d-flex flex-column flx-1">
                    <div className="bc_article-message_view flx-1" onScroll={handleScroll} >
                        <div>
                            {
                        ...
                        </div>
                        {
                            newListFeedback_20.map((feedback, index) => (
                                <div key={feedback.id} ref={newListFeedback_20.length === index + 1 ? targetDivRef : undefined}>
                                    <Row>
                                        <Col xs={12}>
                    ...
                    <div>
                        <div className="d-flex justify-content-center" style={{gap: '1.5rem', margin: "0 46px"}}>
                            <div className="flx-1">
                                <InputField handleInputChange={handleInputChange} placeholder="Aa" value={value} ref={inputValue} className={'bc-group_input'} />
                            </div>
                            <div>
